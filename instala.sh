...
echo -e "\033[1;36mwget https://raw.githubusercontent.com/theonejpas/geneadm/master/Install/apt-source.sh && chmod 777 ./* && ./apt-*"
echo -e "${cor[5]}=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠=≠"
echo -ne "\033[0m"
exit 1
}
...
wget -O trans https://raw.githubusercontent.com/theonejpas/geneadm/master/Install/trans -o /dev/null 2>&1
